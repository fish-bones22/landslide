...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 16, 2017 at 06:25 PM
...
(53, 'SocialNetwork - PHP Social Networking System', 'Social Network â€“ PHP Social Networking System is a powerful PHP script designed to allow you to create your own Social Network! It uses a beautiful Bootstrap design, has integrated live chat, pages, albums, image uploading, powerful Admin Panel and more. Itâ€™s powered by MySQL and PHP.', 1, 14, '/landslide/product-files/icons/SocialNetwork - PHP Social Networking System_Dev Name', '/landslide/product-files/zip/SocialNetwork - PHP Social Networking System_Dev Name.zip', 305447, 500, 1, 1, '2017-11-13 00:04:31'),
(54, 'CryptoCompare', 'CryptoCompare is a PHP web application, which displays general information, quotes and interactive historical charts for more than 1500 cryptocurrencies. It is designed to allow you quickly get a website like coinmarketcap.com up and running.', 1, 14, '/landslide/product-files/icons/CryptoCompare_Dev Name', '/landslide/product-files/zip/CryptoCompare_Dev Name.zip', 305447, 530, 1, 1, '2017-11-13 00:05:22'),
(55, 'Unlimited Addons Package', 'The biggest Addon bundle for WPBakery Page Builder (Visual Composer) with +700 addons and +30 Predefined Templates. All addons are totally unique, crafted individually to fit your WPBakery Page Builder (Visual Composer) website.', 1, 14, '/landslide/product-files/icons/Unlimited Addons Package_Dev Name', '/landslide/product-files/zip/Unlimited Addons Package_Dev Name.zip', 305447, 600, 1, 1, '2017-11-13 00:06:17');
...
(6, 54, 17, 3, '2017-11-13 11:08:03'),
(7, 55, 17, 5, '2017-11-13 11:09:46'),
(8, 51, 13, 5, '2017-11-13 21:06:52'),
(9, 53, 13, 5, '2017-11-13 21:06:52'),
(10, 46, 13, 4, '2017-11-13 21:06:53');
...
(19, 9, 17, 54, 'CryptoCompare', 530, '2017-11-13 11:08:03'),
(20, 10, 17, 55, 'Unlimited Addons Package', 600, '2017-11-13 11:09:46'),
(21, 11, 13, 51, 'RespoGrid', 300, '2017-11-13 21:06:52'),
(22, 11, 13, 53, 'SocialNetwork - PHP Social Networking System', 500, '2017-11-13 21:06:52'),
(23, 11, 13, 46, 'Enigma', 120, '2017-11-13 21:06:53');
...
(13, 'drawdej963@gmail.com', '123456', 3, 'Ej', 'Mindanao', 1, 108643, 1, '2017-11-11 09:11:20'),
(14, 'marxs@gmail.com', '123123', 3, 'Marx Jendre', 'Sabandana', 1, 99999, 1, '2017-11-12 23:40:55'),
(15, 'po@g.com', '123', 1, 'Pou', 'Yeah', 1, NULL, 1, '2017-11-13 10:19:05'),
(16, 'pou@gmail.com', '123', 2, 'Pou', 'Pou', 1, NULL, 1, '2017-11-13 10:19:34'),
(17, 'jerushalom@gmail.com', '12345', 2, 'Jeru', 'Barlos', 1, 98870, 1, '2017-11-13 11:02:50');
...
--
ALTER TABLE `tbl_dev_info`
  MODIFY `dev_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
...
--
ALTER TABLE `tbl_transaction`
  MODIFY `trans_tbl_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
--
